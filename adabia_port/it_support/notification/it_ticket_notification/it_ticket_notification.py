...
def get_context(context):
	...
	# frappe.errprint(doc.modified)
	# frappe.errprint(doc.creation)
	if doc.creation != doc.modified:
		context['modified'] = True
	
		
	context['assigned_to'] = frappe.get_value('User', filters={'name': doc.assign_to}, fieldname='full_name')
	frappe.errprint(context['assigned_to'])
