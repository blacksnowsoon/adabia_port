...
class SPSOperationTask(Document):
	...
	def sync_assignment(self):
		...
		try:
			...
			frappe.log_error(frappe.get_traceback(), 'SPSOperationTask.sync_assignment error')
	...
	def save(self, *args, **kwargs):
		...
		try:
			...
			frappe.log_error(frappe.get_traceback(), 'SPSOperationTask.save sync_assignment error')
