...
`<div class="footer-content navbar px-2">
    ...
    <p>Go Smart Ticket OS Version 0.0.1</p>
  </div>`;
...
function fetchDoc({doctype='', name=''}) {
  return new Promise((resolve, reject) => {
    frappe.call({
      method: 'gosmart_ticket_os.utils.get_document',
      args: {
        doctype: doctype,
        name: name,
      },
...
function fetchList({doctype='', filters={}, fields=[]}) {
  return new Promise((resolve, reject) => {
    frappe.call({
      method: 'gosmart_ticket_os.utils.get_list',
      args: {
        doctype: doctype,
        fields: fields,
        filters: filters
...
function fetchAll({doctype='', filters={}, fields=[]}) {
  return new Promise((resolve, reject) => {
    frappe.call({
      method: 'gosmart_ticket_os.utils.get_all',
      args: {
        doctype: doctype,
        fields: fields,
        filters: filters
...
function get_customs_declarations_sum(parent, operation_type, operation_handler, is_count) {
  return new Promise((resolve, reject) => {
    frappe.call({
      method: 'gosmart_ticket_os.utils.get_customs_declarations_sum',
      args: {
        parent: parent,
