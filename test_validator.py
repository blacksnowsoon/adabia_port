...
sys.path.insert(0, '/home/frappe/fbench/apps/adabia_port')

def test_messages():
    """Test validator with real messages"""
    
    # Read the sample files
    msg2701_path = '/home/frappe/fbench/apps/adabia_port/sample_msg2701.xml'
    ...
    # Import validator
    try:
        from adabia_port.validate3501 import UniversalMessageValidator
    except ImportError:
